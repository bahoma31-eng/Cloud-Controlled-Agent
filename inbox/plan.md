1. [DONE] Create a Python script named 'helper.py' to handle GitHub API requests.
2. [DONE] Import necessary libraries, including 'requests' and 'json'.
3. [DONE] Define variables for REPO_OWNER, REPO_NAME, and GITHUB_TOKEN.
